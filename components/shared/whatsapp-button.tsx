...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-24 right-4 z-50 flex h-14 w-14 animate-wa-pulse items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-110 active:scale-95 md:bottom-5 md:right-5"
    >
